...
export default function UserLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setError("");
    try {
      await userApi.post("/api/auth/login", { email, password });
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[52%] relative overflow-hidden bg-gradient-to-br from-violet-950 via-purple-900 to-violet-900">
        ...
        <div className="absolute top-1/2 right-28 w-8 h-8 bg-violet-400/10 rounded-lg rotate-45 animate-[float_6s_ease-in-out_infinite_2s]" />
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="max-w-md">
            ...
            <p className="text-violet-300/60 mt-6 text-base leading-relaxed">
              Discover volunteering opportunities, connect with charities, and
              track your impact all from one place.
            </p>
      ...
      <div className="flex-1 flex items-center justify-center bg-gray-50 px-6 py-12 relative">
        ...
        <div className="relative z-10 w-full max-w-[400px]">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500 mt-2">Sign in to browse and manage your volunteering.</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-11 pr-4 py-3 text-sm bg-white border border-gray-200 rounded-xl focus:border-violet-300 focus:ring-2 focus:ring-violet-100 outline-none transition-all placeholder:text-gray-300"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-11 pr-11 py-3 text-sm bg-white border border-gray-200 rounded-xl focus:border-violet-300 focus:ring-2 focus:ring-violet-100 outline-none transition-all placeholder:text-gray-300"
                />
                <button
                  type="button"
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 text-center">
            <p className="text-sm text-gray-500">
              ...
              <Link href="/user/register" className="text-violet-600 hover:text-violet-700 font-semibold transition-colors">
                Create one
              </Link>
            </p>
          </div>
